...
- add high availability configuration to conf/flink-conf.yaml https://nightlies.apache.org/flink/flink-docs-master/docs/deployment/ha/kubernetes_ha/#example-configuration
